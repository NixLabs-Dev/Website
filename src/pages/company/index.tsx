    ...
    <main className="flex flex-col">
      <div id="heading" className="lg:grid lg:grid-cols-3 gap-12 my-8">
        <div className="col-span-2">
          ...
          <h3 className="mt-3 text-xl text-zinc-300">
            ...
            plan to keep community in technology and we always remember where we
            came from. From startup, to fortune 500 and beyond we promise to
            keep our morals. Because thats who we are.
          </h3>
        </div>
      ...
      <div className="pt-2 flex flex-col items-center my-8">
        ...
        <p className="text-lg mt-8 mx-4 text-center">
          At NixLabs Networks, we are dedicated to Free and Open Source Software
          (FOSS), building our entire infrastructure on open solutions. From
          networking to virtualization, our systems reflect this commitment, and
          we contribute back by open-sourcing select tools and automation.
          Everything we do supports the growth and advancement of the FOSS
          community. Its in our blood.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 w-full mt-12">
          ...
          <div className="col-span-2">
            ...
            <p>
              ...
              massive? Do you love networking, servers and more? Then you might
